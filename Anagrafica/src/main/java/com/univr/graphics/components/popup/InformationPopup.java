...
public class InformationPopup implements Popup {
    @Override
    public void createPopup(String message) {
        ...
        popUpWindow.setTitle("Successo");

        // Aggiunta immagine successo
        ImageView imageView = null;
        try {
            // Creazione di un'immagine
            Image image = new Image(new FileInputStream("src/main/resources/com/univr/anagrafica/success_logo.png"));
            Image imageTitle = new Image(new FileInputStream("src/main/resources/com/univr/anagrafica/success_logo.png"));
